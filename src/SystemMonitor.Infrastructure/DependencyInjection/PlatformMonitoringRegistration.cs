...
public static class PlatformMonitoringRegistration
{
    ...
    /// </summary>
    #pragma warning disable CA1416 // Windows implementations are selected only after an IsWindows check.
    ...
    /// </summary>
#pragma warning disable CA1416 // Linux implementations are selected only after an IsLinux check.
...
#pragma warning restore CA1416
    ...
    /// Some sensors may be unavailable without elevated privileges.
    /// </summary>
#pragma warning disable CA1416 // macOS implementations are selected only after an IsMacOS check.
